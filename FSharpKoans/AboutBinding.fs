...
*)
   ...
   *)
    ...
    let ``08 An identifier pattern will match anything`` () =
        let x = 1 // replace with an integer
        let y = "two" // replace with a string
        let z = '3' // replace with anything else!
    ...
    let ``09 A wildcard pattern will match anything`` () =
        ...
        let _ = "two" // replace with a string
        let _ = '3' // replace with anything else!
        ()
